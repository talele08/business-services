...
public class CollectionsQueryBuilder {
    ...
    private static final String SELECT_RECEIPTS_SQL = "Select rh.id as rh_id,rh.payername as rh_payername,rh" +
            ...
            "from egcl_receiptheader_v1 rh INNER JOIN egcl_receiptdetails_v1 rd ON rh.id=rd.receiptheader " +
            "INNER JOIN egcl_receiptinstrument_v1 recins ON rh.id=recins.receiptheader " +
